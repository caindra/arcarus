 ...
 */
final class Version20240426110535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `group` (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, academic_year_id INT NOT NULL, class_picture_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_6DC044C532C8A3DE (organization_id), INDEX IDX_6DC044C5C54F3401 (academic_year_id), UNIQUE INDEX UNIQ_6DC044C558484F1D (class_picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE group_professor (group_id INT NOT NULL, professor_id INT NOT NULL, INDEX IDX_B9BE8B02FE54D947 (group_id), INDEX IDX_B9BE8B027D2D84D5 (professor_id), PRIMARY KEY(group_id, professor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE student (id INT NOT NULL, group_id INT DEFAULT NULL, INDEX IDX_B723AF33FE54D947 (group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE template (id INT AUTO_INCREMENT NOT NULL, organization_id INT NOT NULL, style_name VARCHAR(255) NOT NULL, layout LONGBLOB NOT NULL, INDEX IDX_97601F8332C8A3DE (organization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_picture (id INT AUTO_INCREMENT NOT NULL, image LONGBLOB NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `group` ADD CONSTRAINT FK_6DC044C532C8A3DE FOREIGN KEY (organization_id) REFERENCES organization (id)');
        ...
        $this->addSql('ALTER TABLE `group` ADD CONSTRAINT FK_6DC044C558484F1D FOREIGN KEY (class_picture_id) REFERENCES class_picture (id)');
        $this->addSql('ALTER TABLE group_professor ADD CONSTRAINT FK_B9BE8B02FE54D947 FOREIGN KEY (group_id) REFERENCES `group` (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE group_professor ADD CONSTRAINT FK_B9BE8B027D2D84D5 FOREIGN KEY (professor_id) REFERENCES professor (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE professor ADD CONSTRAINT FK_790DD7E38D96E056 FOREIGN KEY (mentored_class_id) REFERENCES `group` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `group` DROP FOREIGN KEY FK_6DC044C558484F1D');
        $this->addSql('ALTER TABLE group_professor DROP FOREIGN KEY FK_B9BE8B02FE54D947');
        $this->addSql('ALTER TABLE group_professor DROP FOREIGN KEY FK_B9BE8B027D2D84D5');
        ...
        $this->addSql('DROP TABLE group_professor');
